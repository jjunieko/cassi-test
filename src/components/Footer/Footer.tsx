...
export default function Footer() {
    return (
        <footer className="bg-[#002D4B] text-white text-sm w-full">
            <div className="w-full max-w-[1440px] h-[375px] gap-8 px-20 pt-10 pb-10 mx-auto">
                <div className="w-full h-full">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-[#FCFC1B] pb-6 mb-6">
